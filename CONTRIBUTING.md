...
Thank you for your interest in contributing to [foreman](https://github.com/dileepadev/foreman)! We welcome contributions, including bug fixes, feature enhancements, documentation improvements, and other general improvements.
...
1. **Fork the repository**  
   ...
   To fork the repository, click the **Fork** button in the top right corner of this page or click [here to fork the repository](https://github.com/dileepadev/foreman/fork).
...
Style is enforced by `ruff`. Types are checked by `mypy` in strict mode, so new code should include full type annotations.
...
- Refer to the following templates and guidelines before submitting your changes:
  - [foreman/](./) - Root directory of the repository
