...
| config        | Build scripts, uv environment, or settings            |
| rules         | Deterministic business rules and policy evaluation    |
| audit         | Execution traces and audit logging                    |
| writes        | Idempotent write engine and deduplication             |
| agent         | Agent lifecycle and execution runtime                 |
| api           | API endpoints or service integrations                 |
| cli           | Command-line interface and tools                      |
| db            | Database models or persistence layer                  |
